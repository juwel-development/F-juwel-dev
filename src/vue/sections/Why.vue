<template>
    <section class="why-section bg-citrus">
        <h2>Boost your sales with a powerful web application</h2>
        <p>With a modern and well optimized website you will increase your reach by raising the user experience. That
            will make you visitors happier and stay longer on you site.</p>
        <h2>Reduce your costs with optimized speed</h2>
